...
void Parse_SBG_ECAN_MSG_IMU_INFO(uint8_t* data, uint32_t* id, uint32_t* time_stamp, uint16_t* imu_status, float* temperature);
...
void Parse_SBG_ECAN_MSG_IMU_DELTA_VEL(uint8_t* data, uint32_t* id, float* delta_vel_x, float* delta_vel_y, float* delta_vel_z);
...
void Parse_SBG_ECAN_MSG_IMU_DELTA_ANGLE(uint8_t* data, uint32_t* id, float* delta_angle_x, float* delta_angle_y, float* delta_angle_z);
...
void Parse_SBG_ECAN_MSG_EKF_ORIENTATION_ACC(uint8_t* data, uint32_t* id, float* roll_acc, float* pitch_acc, float* yaw_acc);
...
SBG_ECAN_MSG_EKF_POS_ACC_t Compose_SBG_ECAN_MSG_EKF_POS_ACC(uint32_t id, int16_t latitude_acc, int16_t longitude_acc, int16_t altitude_acc);
void Parse_SBG_ECAN_MSG_EKF_POS_ACC(uint8_t* data, uint32_t* id, int16_t* latitude_acc, int16_t* longitude_acc, int16_t* altitude_acc);
...
SBG_ECAN_MSG_EKF_VEL_NED_t Compose_SBG_ECAN_MSG_EKF_VEL_NED(uint32_t id, int16_t velocity_n, int16_t velocity_e, int16_t velocity_d);
void Parse_SBG_ECAN_MSG_EKF_VEL_NED(uint8_t* data, uint32_t* id, int16_t* velocity_n, int16_t* velocity_e, int16_t* velocity_d);
...
SBG_ECAN_MSG_EKF_VEL_BODY_t Compose_SBG_ECAN_MSG_EKF_VEL_BODY(uint32_t id, int16_t velocity_x, int16_t velocity_y, int16_t velocity_z);
void Parse_SBG_ECAN_MSG_EKF_VEL_BODY(uint8_t* data, uint32_t* id, int16_t* velocity_x, int16_t* velocity_y, int16_t* velocity_z);
...
SBG_ECAN_MSG_AUTO_TRACK_SLIP_CURV_t Compose_SBG_ECAN_MSG_AUTO_TRACK_SLIP_CURV(uint32_t id, int16_t angle_track, int16_t angle_slip, uint16_t curvature_radius, uint8_t auto_status);
void Parse_SBG_ECAN_MSG_AUTO_TRACK_SLIP_CURV(uint8_t* data, uint32_t* id, int16_t* angle_track, int16_t* angle_slip, uint16_t* curvature_radius, uint8_t* auto_status);
...
SBG_ECAN_MSG_AIR_DATA_INFO_t Compose_SBG_ECAN_MSG_AIR_DATA_INFO(uint32_t id, uint32_t time_stamp, uint8_t air_data_status, int16_t air_temperature);
void Parse_SBG_ECAN_MSG_AIR_DATA_INFO(uint8_t* data, uint32_t* id, uint32_t* time_stamp, uint8_t* air_data_status, int16_t* air_temperature);
...
SBG_ECAN_MSG_AIR_DATA_AIRSPEED_t Compose_SBG_ECAN_MSG_AIR_DATA_AIRSPEED(uint32_t id, int32_t pressure_diff, int16_t airspeed);
...
SBG_ECAN_MSG_GPS1_POS_ALT_t Compose_SBG_ECAN_MSG_GPS1_POS_ALT(uint32_t id, int32_t altitude, int16_t undulation, uint8_t num_sv, uint8_t diff_corr_age);
void Parse_SBG_ECAN_MSG_GPS1_POS_ALT(uint8_t* data, uint32_t* id, int32_t* altitude, int16_t* undulation, uint8_t* num_sv, uint8_t* diff_corr_age);
...
SBG_ECAN_MSG_GPS1_POS_ACC_t Compose_SBG_ECAN_MSG_GPS1_POS_ACC(uint32_t id, uint16_t lat_acc, uint16_t long_acc, uint16_t alt_acc, uint16_t base_station_id);
void Parse_SBG_ECAN_MSG_GPS1_POS_ACC(uint8_t* data, uint32_t* id, uint16_t* lat_acc, uint16_t* long_acc, uint16_t* alt_acc, uint16_t* base_station_id);
...
SBG_ECAN_MSG_EVENT_TIME_A_t Compose_SBG_ECAN_MSG_EVEN_TIME_A(uint32_t id, uint16_t time_offset_0, uint16_t time_offset_1, uint16_t time_offset_2, uint16_t time_offset_3);
void Parse_SBG_ECAN_MSG_EVENT_TIME_A(uint8_t* data, uint32_t* id, uint16_t* time_offset_0, uint16_t* time_offset_1, uint16_t* time_offset_2, uint16_t* time_offset_3);
...
SBG_ECAN_MSG_EVENT_TIME_B_t Compose_SBG_ECAN_MSG_EVEN_TIME_B(uint32_t id, uint16_t time_offset_0, uint16_t time_offset_1, uint16_t time_offset_2, uint16_t time_offset_3);
void Parse_SBG_ECAN_MSG_EVENT_TIME_B(uint8_t* data, uint32_t* id, uint16_t* time_offset_0, uint16_t* time_offset_1, uint16_t* time_offset_2, uint16_t* time_offset_3);
...
SBG_ECAN_MSG_EVENT_TIME_C_t Compose_SBG_ECAN_MSG_EVEN_TIME_C(uint32_t id, uint16_t time_offset_0, uint16_t time_offset_1, uint16_t time_offset_2, uint16_t time_offset_3);
void Parse_SBG_ECAN_MSG_EVENT_TIME_C(uint8_t* data, uint32_t* id, uint16_t* time_offset_0, uint16_t* time_offset_1, uint16_t* time_offset_2, uint16_t* time_offset_3);
...
SBG_ECAN_MSG_EVENT_TIME_D_t Compose_SBG_ECAN_MSG_EVEN_TIME_D(uint32_t id, uint16_t time_offset_0, uint16_t time_offset_1, uint16_t time_offset_2, uint16_t time_offset_3);
void Parse_SBG_ECAN_MSG_EVENT_TIME_D(uint8_t* data, uint32_t* id, uint16_t* time_offset_0, uint16_t* time_offset_1, uint16_t* time_offset_2, uint16_t* time_offset_3);
...
SBG_ECAN_MSG_EVENT_TIME_E_t Compose_SBG_ECAN_MSG_EVEN_TIME_E(uint32_t id, uint16_t time_offset_0, uint16_t time_offset_1, uint16_t time_offset_2, uint16_t time_offset_3);
void Parse_SBG_ECAN_MSG_EVENT_TIME_E(uint8_t* data, uint32_t* id, uint16_t* time_offset_0, uint16_t* time_offset_1, uint16_t* time_offset_2, uint16_t* time_offset_3);
