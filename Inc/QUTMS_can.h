...
/** AMS */
	...
	BMU_TransmitSOC_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0xD2, 0x00),
	BMU_TransmitPackSummary_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0xD1, 0x00),
