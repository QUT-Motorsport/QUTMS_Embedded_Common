...
enum CAN_MSG_IDs {
	...
	AMS_CellTemperatureShutdown_ID 	= Compose_CANId(CAN_PRIORITY_ERROR, CAN_SRC_ID_AMS, DRIVER, CAN_TYPE_ERROR, 0x1, 0x0),
	...
	VCU_AirPressure_ID 				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x04, 0x00),
	VCU_MotorTemp_ID 				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x05, 0x00),
	VCU_Pedal_Accel_ID				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x06, 0x00),
	VCU_Pedal_Brake_ID				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x07, 0x00),
