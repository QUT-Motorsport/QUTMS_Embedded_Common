...
enum CAN_MSG_IDs {
	...
	VCU_IMU_Accel_ID 				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x06, 0x00),
	VCU_IMU_Gyro_ID 				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x07, 0x00),

	VCU_MotorTemp_ID 				= Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x08, 0x00),
