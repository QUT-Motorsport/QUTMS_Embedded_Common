...
/** AMS */
	...
	BMU_TransmitVoltage_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0x00, 0x00),
	BMU_TransmitTemperature_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0x01, 0x00),
	BMU_TransmitBalancing_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0x02, 0x00),
	BMU_TransmitDieTemps_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0x03, 0x00),
