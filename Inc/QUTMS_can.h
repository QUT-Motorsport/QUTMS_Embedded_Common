...
/** AMS */
	...
	BMU_TransmitPower_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_BMU, DRIVER, CAN_TYPE_TRANSMIT, 0xE0, 0x00),
...
// Shutdown
	...
	SHDN_Heartbeat_ID = Compose_CANId(CAN_PRIORITY_HEARTBEAT, CAN_SRC_ID_SHDN, DRIVER, CAN_TYPE_HEARTBEAT, 0x0, 0x0),
#endif
...
// VCU
	...
	VCU_Flow_Rate_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x0C, 0x00),
	VCU_Wheel_Speed_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x0D, 0x00),
//	VCU_Linear_Potentiometer_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x0E, 0x00),
	VCU_Pitot_Tube_ID = Compose_CANId(CAN_PRIORITY_NORMAL, CAN_SRC_ID_VCU, DRIVER, CAN_TYPE_TRANSMIT, 0x0F, 0x00),
...
#ifdef QUTMS_CAN_AV
	AV_Heartbeat_ID = Compose_CANId(CAN_PRIORITY_HEARTBEAT, CAN_SRC_ID_AV, DRIVERLESS, CAN_TYPE_HEARTBEAT, 0x0, 0x0),
	ROS_Heartbeat_ID = Compose_CANId(CAN_PRIORITY_HEARTBEAT, CAN_SRC_ID_ROS, DRIVERLESS, CAN_TYPE_HEARTBEAT, 0x0, 0x0),
	Request_ID = Compose_CANId(CAN_PRIORITY_HEARTBEAT, CAN_SRC_ID_RQST, DRIVERLESS, CAN_TYPE_HEARTBEAT, 0x0, 0x0),
#endif
};
