...
typedef enum  {
	...
	ACM_STATE_GAS_CHECK = 0x01,
	ACM_STATE_BOARD_CHECK = 0x02,
	ACM_STATE_ASMS_KEY = 0x03,
	ACM_STATE_BRAKE_CHECK = 0x04,
	ACM_STATE_BRAKE_TEST = 0x05,
	ACM_STATE_BRAKE_LOW = 0x06,
	ACM_STATE_BRAKE_HIGH = 0x07,
	ACM_STATE_CTRL_ACK = 0x08,
	ACM_STATE_MISSION_CHECK = 0x10,
	ACM_STATE_PCHRG_PRESSED = 0x11,
	ACM_STATE_CHECK_TS = 0x12,
	ACM_STATE_CHECK_COMPUTE = 0x13,
	ACM_STATE_READY = 0x14,
	ACM_STATE_BRAKE_RELEASE = 0x15,
	ACM_STATE_DRIVE = 0x16,
	ACM_STATE_BRAKE_ACTIVATE = 0x17,
